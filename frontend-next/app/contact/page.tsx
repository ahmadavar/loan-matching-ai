    ...
    <div className="max-w-xl mx-auto px-6 py-24">
      ...
      {status === "success" ? (
        <div className="rounded-lg border border-[#38bdf8]/30 bg-[#38bdf8]/5 px-6 py-8 text-center">
          ...
          <p className="text-white/80 font-medium">Message received</p>
          <p className="text-white/40 text-sm mt-1">We&apos;ll get back to you shortly.</p>
          <button
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full bg-white/[0.04] border border-white/10 rounded-md px-4 py-2.5 text-sm text-white placeholder:text-white/25 focus:outline-none focus:border-[#38bdf8]/50 transition-colors"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-white/[0.04] border border-white/10 rounded-md px-4 py-2.5 text-sm text-white placeholder:text-white/25 focus:outline-none focus:border-[#38bdf8]/50 transition-colors resize-none"
            />
          </div>
